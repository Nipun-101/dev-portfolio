                ...
                >
                    ...
                    lg:items-center p-3 py-6 md:p-5 lg:p-10 gap-2'>
                        ...
                        <div className='lg:ms-5'>
                            <h1 className='
                            text-start text-xl md:text-2xl font-bold'>
                                {'Download my CV '}<a href={'/nipun_deleep_software_engineer_cv_2025.pdf'} download="nipun_deleep_software_engineer_cv_2025" className='text-blue-600 cursor-pointer underline'>{'here'}</a>
                            </h1>
                            <p className='
                            text-start text-white-100 mt-3 font-semibold'>
